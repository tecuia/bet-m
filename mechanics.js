...
const episodes = [
    {
        ...
        loseTitle: 'ВЫ НЕ УГАДАЛИ',
        loseText: 'Это был легендарный гол Робина ван Перси «рыбкой» в ворота сборной Испании на Чемпионате Мира 2014.'
    },
    {
        videoSrc: '',
        pauseTime: 0,
        ...
        loseTitle: 'ВЫ НЕ УГАДАЛИ',
        loseText: 'Касильяс совершил один из самых важных сейвов ЧМ-2010 — отбил удар Роббена ногой в финале Испания — Нидерланды'
    },
    {
        ...
        loseTitle: 'ВЫ НЕ УГАДАЛИ',
        loseText: 'Мбаппе забил один из самых ярких голов ЧМ-2022 — ударом с лёта в финале Аргентина — Франция'
    }
];
...
function showBonusScreen(isFinishedAllRounds = false) {
    ...
    if (!isFinishedAllRounds) {
        ...
        if (correctAnswersCount === 3) {
            ...
            bonusTitle.textContent = 'БОНУС ЖДЁТ ТЕБЯ';
            bonusSubtitle.textContent = 'Ноль точных прогнозов из трёх. Переходи на сайт Бет-М, забирай фрибет и делай просмотр матчей ярче';
        }
    }
